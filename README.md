...
- 컴포넌트 단위별 디렉토리 내부에는 `component.tsx`, `component.style.ts`, `component.stories.tsx` 파일이 각각 존재합니다.
...
📦src
 ...
 ┃ ┃ ┣ 📂AwardItem    // 1-1. Awards에 반복적으로 사용되는 AwardItem Component
 ┃ ┃ ┃ ┣ 📜AwardItem.style.ts
 ┃ ┃ ┃ ┗ 📜index.tsx
 ┃ ┃ ┣ 📜Awards.stories.tsx
 ┃ ┃ ┣ 📜Awards.style.ts
 ...
 ┃ ┃ ┣ 📂MetricItem   // 3-2. Metrics에 반복적으로 사용되는 MetricItem Component
 ┃ ┃ ┃ ┣ 📜index.tsx
 ┃ ┃ ┃ ┗ 📜MetricItem.style.ts
 ┃ ┃ ┣ 📜index.tsx
 ┃ ┃ ┣ 📜Metrics.stories.tsx
